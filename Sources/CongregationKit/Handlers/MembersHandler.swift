...
///
/// Provides methods to fetch all members or a specific member by ID, with support for pagination and expanded fields.
public protocol MembersHandler: Sendable {
    ...
    @available(
        *, deprecated,
        message:
            "This method no longer fetches a single member due to backend API changes. Use fetch(id:) with MemberID for correct, type-safe single-member retrieval."
    )
...
///
/// Handles all member-related operations using the Salesforce API.
